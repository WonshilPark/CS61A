...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat2, lat1 = get_lat(city2), get_lat(city1)
    lon2, lon1 = get_lon(city2), get_lon(city1)
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    new_city = make_city('place', lat, lon)

    d1 = distance(city1, new_city)
    d2 = distance(city2, new_city)
