...
def is_swap(player_score, opponent_score):
    ...
    if opponent_score // 10 == 0:
    	opponent_total = opponent_score ** 2

    if player_score < 100 and player_score >= 10:
    	player_total = (player_score % 10) * (player_score // 10)

    if opponent_score < 100 and opponent_score >= 10:
    	opponent_total = (opponent_score % 10) * (opponent_score // 10)

    if player_score >= 100:
    	player_total = (player_score % 10) * (player_score // 100)

    if opponent_score >= 100:
    	opponent_total = (opponent_score % 10) * (opponent_score // 100)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if player == 0:
            ...
            if feral_hogs:
            	if abs(prev_roll0 - num_rolls) == 2:
            		score0 += 3
            prev_roll0 = num_rolls
            score0 += take_turn(num_rolls, score1, dice)

        elif player == 1:
            num_rolls = strategy1(score1, score0)
            if feral_hogs:
            	if abs(prev_roll1 - num_rolls) == 2:
            		score1 += 3
            prev_roll1 = num_rolls
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while index <= 10:
    	if averaged_dice(index, dice) > max_score:
    		max_score = averaged_dice(index, dice)
    		best_roll = index
    	index += 1
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if score < opponent_score and is_swap(score, opponent_score):
    	return 0
    elif score > opponent_score and is_swap(score, opponent_score):
    	return num_rolls
    else:
